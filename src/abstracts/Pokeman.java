...
/**
 * Pokeman
 * Constructor for the Pokeman abstract class
 * @param name The name of the pokeman
 * @param level The level of the pokeman
 */
...
/**
 * tryToCatch
 * Checks a randomly generated number against an equation using the
 * angry and eating stats. If the random number is lower than the calculated number, 
 * the pokeman is caught.
 * @param angry The angry stat of the pokeman, modified by throwing rocks.
 * @param eating The eating stat of the pokemon, modified by throwing bait.
 * @return
 */
  ...
  /**
   * Generates a random number and checks if the pokemon can run by comparing it to the toRun stat.
...
/**
 * getLevel
 * Returns the level of the Pokeman
 ...
 */
  ...
  /**
   * getSprite
   * Returns the sprite for the Pokeman
...
/**
 * Calculates the run chance of the Pokeman, using the battlelength, eating, and angry stats.
 * If the battle length is greater than 10, or if the toRun stat is greater than the random value generated
 * in checkRun, the Pokemon runs.
 * @param battleLength The length of the current battle
 * @param angry The angry stat of the Pokeman
 * @param eating The eating stat of the Pokeman
