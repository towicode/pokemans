...
public class Map {
    ...
    for (int y = 0; y < MAP_HEIGHT; y++) {
      for (int x = 0; x < MAP_WIDTH; x++) {
        tiles[x][y] = new Tile(x * TILE_SIZE, y * TILE_SIZE,
            Constants.flatMap[counter], true);
  ...
  /**
   * loadStartingMap Loads the first map
   * 
   * @param up_offset
   * @param down_offset
   * @param left_offset
  ...
  /**
   * adjustRight Adjusts the map right by an offset
   */
  ...
  /**
   * adjustLeft Adjusts the map left by an offset
   */
  ...
  /**
   * adjustUp Adjusts the map up by an offset
   */
  ...
  /**
   * adjustDown Adjusts the map down by an offset
   */
  ...
  /**
   * draw Draws the map on the screen
   * 
   * @param graphics
   */
  ...
  /**
   * getTiles return the array of tiles representing the map
   * 
   * @return Tile[][]
   */
  ...
  /**
   * setTIles sets the tiles for the map to a given tile array
   * 
   * @param tiles
   */
  ...
  /**
   * getGrassTileRaw returns the grass tiles for the map as an int array
   * 
   * @return int
   */
  ...
  /**
   * setGrassTileRaw Sets this maps grassTileRaw array to a given array
   * 
   * @param grassTileRaw
   *          []
   */
  ...
  /**
   * getId Return the id of the map
   * 
   * @return int
   */
  public int getId() {
  ...
  public void deleteMap1Item() {
    tiles[11][10] = new Tile(tiles[11][10].x, tiles[11][10].y, 0, true);
  }

  public void deleteMap3Item() {
    tiles[24][7] = new Tile(tiles[24][7].x, tiles[24][7].y, 0, true);
